---
title: Discount Rate Formulation
description: Discounted Bellman equation, stage-dependent discount factors, the discount applied to the future cost variable θ, cumulative discounting, and lower/upper bound computation with discount.
---
...
For stopping rules that use these bounds, see [Stopping Rules](/math/stopping-rules).
...
- [SDDP Algorithm](/math/sddp-algorithm) — Core Bellman equation and forward/backward pass structure that discount rates modify
