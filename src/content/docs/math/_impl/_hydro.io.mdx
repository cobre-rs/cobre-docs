...
the Reference corpus (case-format and output-format pages); those pages are
not part of this build yet, so the entries below are prose pointers rather
than links until they land.
