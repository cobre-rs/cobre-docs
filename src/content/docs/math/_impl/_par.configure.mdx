...
| 4 | 1 | 0 | 0 | `FullEstimation` | fitted from H | fitted from H (PACF + Yule-Walker + Maceira-Damazio) | estimated from H residuals, unless `correlation.json` provided |
...
Required to drive any of the estimation paths (H = 1 above). One row per
