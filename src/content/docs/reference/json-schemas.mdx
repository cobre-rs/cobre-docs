---
title: JSON Schemas
description: The 17 vendored JSON Schema files describing every JSON input file in a Cobre case directory, plus editor `$schema` integration instructions.
---
...
`https://raw.githubusercontent.com/cobre-rs/cobre/v0.13.0/schemas/config.schema.json`.
...
copy (currently at the `v0.13.0` tag) under `public/schemas/` so the files
