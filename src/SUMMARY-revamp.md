...
- [Infinite Horizon (legacy, folds into horizon-modes in Epic 04)](./specs/math/infinite-horizon.md)
...
- [1dtoy Walkthrough](./specs/examples/1dtoy.md)
- [4ree Walkthrough](./specs/examples/4ree.md)
