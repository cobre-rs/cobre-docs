...
| FPHA             | Função de Produção Hidrelétrica Aproximada | Approximate Hydroelectric Production Function — piecewise-linear model of hydro generation as a function of storage, flow, and spillage |
