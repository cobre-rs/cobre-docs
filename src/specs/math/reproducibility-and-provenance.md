...
The companion chapter [Determinism Guarantees](./determinism-guarantees.md)
...
- **Stochastic-fitting metadata.** The diagnostics produced when the
  ...
  parameters, see [Scenario Generation](./scenario-generation.md).
...
- **Random-seed lineage.** The root seed that the operator supplied, and
  ...
  rule itself is documented in [Scenario Generation](./scenario-generation.md)
...
- **Execution topology.** The MPI rank count and the threading
  ...
  [Determinism Guarantees](./determinism-guarantees.md): that chapter
...
chapter [Determinism Guarantees](./determinism-guarantees.md) establishes the
...
- [Determinism Guarantees](./determinism-guarantees.md) — The companion
  ...
  actionable
- [Scenario Generation](./scenario-generation.md) — Reproducible sampling
