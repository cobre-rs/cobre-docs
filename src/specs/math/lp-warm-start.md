...
Cut selection (see [Cut Management](./cut-management.md)) deactivates,
...
pool assigns every cut a stable slot index (see [Cut Management §5](./cut-management.md)),
...
> **Retired knob.** Earlier releases predicted each re-introduced cut's basis
...
- [Cut Management](./cut-management.md) — The append-only cut lifecycle with
