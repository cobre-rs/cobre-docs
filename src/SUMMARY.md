...
- [Architecture](./specs/architecture.md)
  ...
  - [Trait Specifications]()
    ...
    - [Risk Measure Testing](./specs/architecture/risk-measure-testing.md)
    - [Horizon Mode Trait](./specs/architecture/horizon-mode-trait.md)
    - [Horizon Mode Testing](./specs/architecture/horizon-mode-testing.md)
    - [Sampling Scheme Trait](./specs/architecture/sampling-scheme-trait.md)
    - [Sampling Scheme Testing](./specs/architecture/sampling-scheme-testing.md)
    - [Cut Selection Strategy Trait](./specs/architecture/cut-selection-trait.md)
    - [Cut Selection Testing](./specs/architecture/cut-selection-testing.md)
    - [Stopping Rule Trait](./specs/architecture/stopping-rule-trait.md)
    - [Stopping Rule Testing](./specs/architecture/stopping-rule-testing.md)
    - [Solver Interface Trait](./specs/architecture/solver-interface-trait.md)
    - [Solver Interface Testing](./specs/architecture/solver-interface-testing.md)
