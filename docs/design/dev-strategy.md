...
> **⚠️ Superseded (2026-07).** This document captures the _original_ two-property
> strategy — a software mdBook at `docs.cobre-rs.dev` plus a separate methodology
...
| **Metrics**        | Auto   | Three numbers: 164K lines, 2,747 tests, 0 proprietary deps.                                                                |
