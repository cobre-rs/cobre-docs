...
description: Navigation guide — seven-Part structure, what each Part covers, and reading paths for different audiences.
---
...
**Familiar with SDDP, new to Cobre**: Skim Part 1, read [Notation Conventions](/overview/notation-conventions) carefully (Part 1.3), then read Part 4. Cross-reference Part 2 for the LP layout when Part 4 refers to stage variables.
...
- [LP Formulation](/math/lp-formulation) — stage LP column layout: Part 2 entry point
- [PAR Inflow Model](/math/par-inflow-model) — periodic autoregressive inflow model: Part 3 entry point
- [SDDP Algorithm](/math/sddp-algorithm) — forward pass, backward pass, cut generation, convergence: Part 4 entry point
- [Horizon Modes](/math/horizon-modes) — boundary conditions and horizon-mode design: Part 5 entry point
